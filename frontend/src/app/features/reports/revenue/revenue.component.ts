...
import { ReportFilter, RevenueRow, SessionTypeOption, TherapistOption } from '../models/report.models';
...
export class RevenueComponent implements OnInit, OnDestroy {
  ...
  onExportCsv(): void {
    if (this.activeFilter) this.reportService.exportReport('revenue', this.activeFilter, 'csv');
  }

  onExportXlsx(): void {
    if (this.activeFilter) this.reportService.exportReport('revenue', this.activeFilter, 'xlsx');
  }
  ...
  private loadPage(page: number): void {
    ...
    this.loading = true;
    this.reportService
      .getRevenue({ ...this.activeFilter, page, size: this.pageSize })
